...
const ChooseUs = () => {
    return (
        <div className='m-10 px-10 pt-10 rounded-xl bg-[#f5f5f5]'>
            <div>
                <div>
                    <h2 className='text-4xl font-bold text-center p-3'>Why Choose Us?</h2>
                    <h5 className='text-center px-40'>Select us for excellent service and a tranquil setting. You will receive customized treatments from our skilled therapists, who will make sure you depart feeling renewed and invigorated. Our top priority is your well-being.</h5>
                </div>
